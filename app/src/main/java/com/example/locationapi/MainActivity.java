...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startLocationUpdatesButton = findViewById(R.id.start_location_update_button);
        stopLocationUpdatesButton = findViewById(R.id.stop_location_update_button);
        locationTextView = findViewById(R.id.result_text_view);
        locationUpdateTimeTextView = findViewById(R.id.location_update_time_text_view);
